...
import { Check, Lock, Mail, Loader2, AlertCircle, ArrowLeft } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden flex flex-col md:items-center md:justify-center">
      ...
      <div className="absolute top-6 left-6 z-20 md:top-8 md:left-8">
        <Link href="/">
          <button className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/40 dark:bg-white/5 border border-white/50 dark:border-white/10 backdrop-blur-md hover:bg-white/60 transition-all text-sm font-medium text-[var(--text-muted)] hover:text-[var(--text-main)] shadow-sm">
      ...
      <div className="
        ...
        bg-white/30 dark:bg-[#0f172a]/30 backdrop-blur-xl
        
        md:min-h-fit md:h-auto md:max-w-md md:p-10
        md:rounded-[32px] md:border md:border-white/50 md:dark:border-white/10 
        md:shadow-2xl md:bg-white/40 md:dark:bg-white/5
        
        transition-all duration-500 animate-in fade-in zoom-in-95
      ">

        <div className="text-center mb-8 md:mb-10 mt-8 md:mt-0">
          <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-6 rounded-2xl md:rounded-3xl bg-gradient-to-tr from-blue-500 to-purple-600 flex items-center justify-center text-white shadow-lg shadow-blue-500/30">
            <Check className="w-8 h-8 md:w-10 md:h-10" strokeWidth={3} />
          </div>
          <h1 className="text-2xl md:text-3xl font-bold text-[var(--text-main)] tracking-tight">Welcome Back</h1>
        ...
        <div className="mt-auto md:mt-8 pt-8 text-center">
          <p className="text-xs text-[var(--text-muted)] opacity-80">
            Powered by <span className="font-semibold text-blue-500">Product QR Verification</span>
          </p>
        </div>
