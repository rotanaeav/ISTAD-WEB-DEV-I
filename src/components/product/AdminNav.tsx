...
export default function AdminNavbar() {
  ...
  if (!mounted) return <div className="h-24 bg-white/60 dark:bg-[#0f172a]/60 border-b border-white/20 dark:border-white/5" />;

  return (
    <header className="h-24 px-8 flex items-center justify-between bg-white/60 dark:bg-[#0f172a]/60 backdrop-blur-xl border-b border-white/20 dark:border-white/5 sticky top-0 z-30 transition-all">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative">
          ...
          >
            ...
            <ChevronDown className={`w-5 h-5 text-slate-400 group-hover:text-blue-500 transition-transform duration-300 hidden md:block ${isDropdownOpen ? 'rotate-180' : ''}`} />
          </button>
              ...
              <div className="absolute right-0 mt-4 w-56 z-50 origin-top-right rounded-2xl bg-white/80 dark:bg-[#0f172a]/90 backdrop-blur-xl border border-white/40 dark:border-white/10 shadow-2xl animate-in fade-in zoom-in-95 slide-in-from-top-2 duration-200">
                <div className="p-2 space-y-1">
                  ...
                  <div className="px-4 py-3 border-b border-gray-100 dark:border-white/5 mb-1">
                    <p className="text-sm font-bold text-[var(--text-main)]">Signed in as</p>
