    ...
    <aside className="fixed left-0 top-0 h-screen w-64 z-40 flex flex-col border-r border-white/20 bg-white/60 dark:bg-[#0f172a]/60 backdrop-blur-2xl">
      ...
      <div className="h-20 flex items-center px-6 border-b border-white/20 dark:border-white/5">
        <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg text-[var(--text-main)]">Admin</span>
        </Link>
      </div>
      ...
      <div className="flex-1 overflow-y-auto py-6 px-4">
        ...
        <div className="mb-6">
          <p className="px-4 text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2">Main</p>
          <SidebarLink href="" icon={LayoutDashboard} label="Dashboard" />
        </div>

        <div>
          <p className="px-4 text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2">Products</p>

          <SidebarLink href="/dashboard/products" icon={Package} label="All Products" />
          
          <SidebarLink href="/dashboard/products/create" icon={PlusCircle} label="Add Product" />
